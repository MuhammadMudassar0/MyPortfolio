...
const projects: Project[] = [
  {
    ...
    description: 'A comprehensive design system and component library built with ShadCN and Tailwind CSS, providing reusable UI components for consistent design across applications.',
    technologies: ['ShadCN', 'Tailwind CSS', 'TypeScript', 'React'],
    githubUrl: 'https://github.com/datawire-ai/busyfile-design-system',
    gradient: 'from-blue-500 via-cyan-500 to-teal-500',
  },
  {
    title: 'Zylospace - SaaS E-commerce Platform',
    description: 'A SaaS e-commerce platform similar to Shopify/WordPress, enabling merchants to create customizable online stores with subdomain-based multi-tenancy.',
    technologies: ['Next.js', 'NestJS', 'PostgreSQL', 'Material UI', 'Tailwind CSS'],
    gradient: 'from-purple-500 via-pink-500 to-rose-500',
  },
  {
    title: 'Attendance Management System',
    description: 'A full-stack attendance management system built with React.js and Node.js, handling both frontend and backend functionalities for efficient workforce tracking.',
    technologies: ['React.js', 'Node.js', 'JavaScript'],
    gradient: 'from-orange-500 via-red-500 to-pink-500',
  },
  {
    title: 'Advisor App',
    description: 'A Next.js application with complete user flow including authentication, file upload processing, and result display. Built with modern UI components and responsive design.',
